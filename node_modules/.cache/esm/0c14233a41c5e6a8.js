let Conf,Table,configKey,validateApiKey,validateCityId,validateUnits,queryWeatherForecast;_41c‍.x([["forecast",()=>forecast]]);_41c‍.w("conf",[["default",["Conf"],function(v){Conf=v}]]);_41c‍.w("cli-table3",[["default",["Table"],function(v){Table=v}]]);_41c‍.w("./configure",[["configKey",["configKey"],function(v){configKey=v}]]);_41c‍.w("./utils",[["validateApiKey",["validateApiKey"],function(v){validateApiKey=v}],["validateCityId",["validateCityId"],function(v){validateCityId=v}],["validateUnits",["validateUnits"],function(v){validateUnits=v}],["queryWeatherForecast",["queryWeatherForecast"],function(v){queryWeatherForecast=v}]]);
  ...
  _41c‍.g.console.log(table.toString());
}
